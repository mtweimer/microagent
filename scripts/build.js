...
const steps = [
  ...
  { key: "schema_generate", label: "Schema Generate", cmd: "node", args: ["scripts/generate-agent-schemas.js"] },
  { key: "schema_check", label: "Schema Check", cmd: "node", args: ["scripts/schema-check.js"] },
  { key: "plugins_validate", label: "Plugin Validate", cmd: "node", args: ["src/cli.js", "plugins", "validate"] },
  { key: "tests", label: "Unit Tests", cmd: "npm", args: ["test"] },
  { key: "system_check", label: "System Check", cmd: "node", args: ["src/cli.js", "check"] },
  {
    key: "prompt_safety",
    label: "Prompt Safety",
    cmd: "node",
    args: ["scripts/run-prompt-tests.js", "--mode", "simulate", "--allow-risk", "low"]
  },
  { key: "doctor", label: "Service Health", cmd: "node", args: ["src/cli.js", "doctor"] }
];
